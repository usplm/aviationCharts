...
main() {
    ...
    local -r airport_diagram_chart_array=(
        # California
        00281_KAPC_AD 00294_KOAK_AD 00375_KSFO_AD 00410_KNUQ_AD 00488_KSUU_AD 00693_KSJC_AD 00696_KSTS_AD 05015_KHWD_AD 05320_KCCR_AD 06075_KLVK_AD
        09216_KPAO_AD 09219_KSQL_AD
        # New York
        # 00411_KSYR_AD
        )
